...
no_time_ode = nn.Sequential(*get_downsampling_layers(), ODEBlock(ConvolutionalDynamicsFunction(64, time_dependent=False), device=device), *get_final_layers())
train_model_cached(no_time_ode, file_path="cached_models/no_time_ode.pth", batch_size=128, test_batch_size=batch_size_test, epochs=n_epochs, verbosity=3, device=device)
